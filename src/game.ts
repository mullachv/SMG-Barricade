module game {
      ...
      var rowsNum = 16;
      var colsNum = 17;
      var draggingStartedRowCol:any = null;
      ...
      function setGlow(row:any, col:any, value:any) {
        var dest:any;
        if (row > 13) {
            row = 13;
      ...
      function isInvalidPos(topLeft:any) {
        var size = getSquareWidthHeight();
      ...
      function setDraggingPieceTopLeft(topLeft:any, moveType:any) {
      ...
      function dragDone(frompos:any, topos:any) {
          ...
          try {
              ...
              if (typeExpected === 'normal') {
                  ...
                  gameService.makeMove(gameLogic.createMove(
                      board, "normal", dice, topos.row, topos.col,
                          frompos.row, frompos.col, turnIndex));
                  ...
                  draggingPiece.style.display = 'none';
                  gameService.makeMove(gameLogic.createMove(
                      board, "barricade", dice, topos.row, topos.col,
                          -1, -1, turnIndex));
              }
          } catch (e) {
      ...
      rows = getIntegersTill(rowsNum);
      cols = getIntegersTill(colsNum);
      rowsNum = rowsNum;
      colsNum = colsNum;
    ...
    var prev_row:any = null;
    var prev_col:any = null;
            ...
            if (prev_row === null || prev_col === null) {
                ...
                try { // choose the end point
                  // to prevent making another move
                    ...
                    gameService.makeMove(gameLogic.createMove(
                        board, "normal", dice, row, col,
                            prev_row, prev_col, turnIndex));
                    prev_row = null;
                    prev_col = null;
                } catch (e) {
    ...
    function passMove() {
      ...
      export let isWinSpot = function (row:any, col:any) {
          return board[row][col] === 'W';
      };
      export let isPieceR = function (row:any, col:any) {
          return board[row][col] === 'R';
      };
      export let isPieceG = function (row:any, col:any) {
          return board[row][col] === 'G';
      };
      export let isPieceB = function (row:any, col:any) {
          return board[row][col] === 'B';
      };
      export let isPieceY = function (row:any, col:any) {
          return board[row][col] === 'Y';
      };
      export let isBarricade = function (row:any, col:any) {
          return board[row][col] === '1';
      };
      export let isEmptySpot = function (row:any, col:any) {
          return board[row][col] === '0';
      };
      export let isRedStart = function (row:any, col:any) {
          return isStart(0, row, col);
      };
      export let isGreenStart = function (row:any, col:any) {
          return isStart(1, row, col);
      };
      export let isYellowStart = function (row:any, col:any) {
          return isStart(2, row, col);
      };
      export let isBlueStart = function (row:any, col:any) {
          return isStart(3, row, col);
      };
      export let isNormalSpot = function(row:any, col:any) {
          return !isWinSpot(row, col) && !isRedStart(row, col) &&
          !isGreenStart(row, col) && !isYellowStart(row, col) &&
          !isBlueStart(row, col);
      };
      function isStart(index:any, row:any, col:any) {
      ...
      export let getDiceSrc = function() {
          switch(dice) {
              case 1:
                  return 'imgs/1.png';
              case 2:
